...
contract FLEXBUXX
{
  ...
  function() external payable { revert(); } // does not accept money
                     ...
                     string memory custom_fallback ) public returns (bool success)
  {
    ...
    if ( isContract(to) )
    {
      ...
      address(rx).call.value(0)(abi.encodeWithSignature(custom_fallback, msg.sender, value, data));
    }

    /*
      bytes4(keccak256(bytes(custom_fallback))),
               msg.sender,
               value,
               data
    */
